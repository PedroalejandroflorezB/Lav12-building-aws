        ...
        <div class="row">
            ...
            <div class="col-md-4 mb-3">
                <div class="input-group">
                    ...
                    <select class="form-select bg-primary text-white border-0" id="sortSelect" name="sort">
                        <option class="option2" value="priceAsc" {{ request('sort') == 'priceAsc' ? 'selected' : '' }}>Precio: menor a
                            mayor</option>
                        <option class="option2" value="priceDesc" {{ request('sort') == 'priceDesc' ? 'selected' : '' }}>Precio: mayor a
                            menor</option>
                    </select>
                </div>
            </div>
